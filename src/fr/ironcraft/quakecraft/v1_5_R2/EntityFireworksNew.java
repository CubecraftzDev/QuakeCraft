package fr.ironcraft.quakecraft.v1_5_R2;
...
public class EntityFireworksNew extends EntityFireworks {
    ...
    public EntityFireworksNew(World world, double d0, double d1, double d2, ItemStack itemstack) {
        super(world);
        this.ticksFlown = 0;
        this.a(0.25F, 0.25F);
    ...
    @Override
	   public void l_() {
	        ...
	        System.out.println("firework new !");
